...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 md:py-32 relative bg-dark-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-dark-400 text-lg mb-10">{t("subtitle")}</p>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-white font-medium mb-1">{t("emailUs")}</h3>
                  <a
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-white font-medium mb-1">{t("callUs")}</h3>
                  <a
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-dark-400">{t("responseTimeText")}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-8">
            {status === "success" ? (
              <div className="text-center py-12">
                ...
                <p className="text-dark-400">{t("success.message")}</p>
                <button
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="dba">{t("form.dba")}</option>
