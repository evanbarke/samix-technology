  ...
  return (
    <footer className="bg-dark-950 border-t border-dark-800/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href={`/${locale}`} className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-lg font-bold text-white">
                Samix<span className="text-primary-400">Tech</span>
              </span>
            </Link>
            <p className="text-dark-500 text-sm">{t("tagline")}</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <span className="text-dark-500 text-sm">SPHYNX SASU</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-dark-800/50 flex flex-col md:flex-row justify-between items-center gap-4">
