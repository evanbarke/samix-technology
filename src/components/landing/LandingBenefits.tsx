...
const serviceIcons: Record<string, Record<string, ReactNode>> = {
  softwareDev: {
    fullstack: (
...
export default function LandingBenefits({ serviceKey, benefitKeys }: LandingBenefitsProps) {
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-white mb-2">
                    {t(`${serviceKey}.benefits.${key}.title`)}
                  </h3>
                  <p className="text-dark-400 text-sm leading-relaxed">
                    {t(`${serviceKey}.benefits.${key}.description`)}
                  </p>
                </div>
              </div>
            </div>
